...
export default function AgreementPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    // Section 7: IP Rights (User specified default)
    ipTransferCondition:
    ...
    // Section 8: Deliverables (User specified default)
    deliverablesList:
      "Complete source code, project files, production-ready application, database schema & migrations (if applicable), API documentation (if applicable), deployment configuration, technical documentation, environment configuration (.env.example), repository access, and all agreed project deliverables as defined in this agreement.",

    // Section 9 & 10: Confidentiality & Support (User specified default)
    confidentialityClause:
      "Both parties agree to keep all confidential information, source code, business data, technical documents, credentials, and project-related information strictly confidential and shall not disclose such information to any third party without prior written consent, except where required by law.",
    freeSupportPeriod: "60 Days Post-Delivery Warranty Support",
