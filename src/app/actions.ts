  ...
  try {
    ...
    if (!profile) {
      ...
      return {
        ...
        phone: "+91 8652601566",
        address: "Thane, Mumbai, Maharashtra",
        upiId: defaultProf.upiId || "sevenxlabs@upi",
        bankName: defaultProf.bankName || "HDFC Bank",
        bankAccount: defaultProf.bankAccount || "50100234567890",
        bankIfsc: defaultProf.bankIfsc || "HDFC0001234",
        paypalEmail: defaultProf.paypalEmail || "sevenxlabs07@gmail.com",
